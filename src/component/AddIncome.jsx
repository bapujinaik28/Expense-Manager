          ...
          <form onSubmit={this.submitHandler.bind(this)} autoComplete={'off'}>
            <fieldset>
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="txt" className="form-input" id="txt" value = {this.state.txt} onChange = {(e)=> this.getText(e)} placeholder="Enter Text.." required />
                </div>

                <div className="form-control">
                    <label htmlFor="txt">+ Amount</label>
